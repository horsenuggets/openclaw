...
- Agents: explicitly filter injected workspace files (Project Context: SOUL/USER/BOOTSTRAP) out of the anthropic-subscription system prompt so requests reliably bill to plan quota instead of spilling to paid extra usage, rather than relying on a blunt character cap.
